...
class Student(models.Model):
    ...
    department = models.CharField(max_length=50, default='default_department')  # New field for department
    section = models.CharField(max_length=10, default='default_section')
